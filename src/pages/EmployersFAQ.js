      ...
      <>
        ...
        <div className="th--faq-leadpsace">
          <LeadSpace 
            ...
            image={{
              sources: [
                { src: this.state.employers_faq.leadspace.background_image.small, breakpoint: 'sm' },
                { src: this.state.employers_faq.leadspace.background_image.medium, breakpoint: 'md' },
              ],
              defaultSrc: this.state.employers_faq.leadspace.background_image.large,
              alt: 'leadspace image',
            }}
          />
        </div>
            ...
            <div className="bx--col-lg-12">
              <Accordion align="start">
                {Object.keys(this.state.employers_faq.list).map(key => 
                  <AccordionItem key={key} title={this.state.employers_faq.list[key].question}>
