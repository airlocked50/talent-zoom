        ...
        <div className="th--faq-leadpsace">
          <LeadSpace
            ...
            image={{
              sources: [
                {
                  src: this.state.job_seekers_faq.leadspace.background_image
                    .small,
                  breakpoint: 'sm',
                },
                {
              ...
              defaultSrc: this.state.job_seekers_faq.leadspace.background_image
                .large,
              alt: 'leadspace image',
            }}
          />
              ...
              <Accordion align="start">
                <Accordion align="start">
                  {Object.keys(this.state.job_seekers_faq.list).map(key => (
                    <AccordionItem
                      key={key}
                      title={this.state.job_seekers_faq.list[key].question}>
